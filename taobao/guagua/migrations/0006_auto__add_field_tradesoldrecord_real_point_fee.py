...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TradeSoldRecord.real_point_fee'
        db.add_column(u'guagua_tradesoldrecord', 'real_point_fee',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TradeSoldRecord.real_point_fee'
        db.delete_column(u'guagua_tradesoldrecord', 'real_point_fee')
    ...
    models = {
        ...
        u'guagua.tradesoldrecord': {
            ...
            'real_point_fee': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
