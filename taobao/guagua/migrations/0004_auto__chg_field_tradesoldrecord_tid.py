...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TradeSoldRecord.tid'
        db.alter_column(u'guagua_tradesoldrecord', 'tid', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'TradeSoldRecord.tid'
        db.alter_column(u'guagua_tradesoldrecord', 'tid', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))
